...
Цей репозиторій містить матеріали курсу "Розріджені матриці в задачах електроенергетики", призначений для студентів із середнім рівнем підготовки.
...
-   `Vymohy_do_zvitu.md`: Вимоги до оформлення звіту з курсової роботи.
